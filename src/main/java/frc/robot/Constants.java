...
public final class Constants {
  public static final class SwerveConstants {
    ...
    // Assuming swerve modules are arrainged in a square, distance from robot geometric center along axis (positive distance)
    public static final double kSwerveX = 0.381; // Meters
    public static final double kSwerveY = 0.381; // Meters
